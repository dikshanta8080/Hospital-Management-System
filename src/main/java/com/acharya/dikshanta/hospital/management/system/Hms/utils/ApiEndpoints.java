...
public class ApiEndpoints {
    ...
    // Patient routes
    public static final String PATIENT_CREATE = "/api/v1/patient/create";
    public static final String PATIENT_GET_ALL = "/api/v1/patient/getall";
    public static final String PATIENT_GET_BY_ID = "/api/v1/patient/get/";
    public static final String PATIENT_DELETE = "/api/v1/patient/delete/";

    // Doctor routes
    public static final String DOCTOR_ADD = "/api/v1/doctor/add";
    public static final String DOCTOR_DELETE = "/api/v1/doctor/delete/";

    // Department routes
    public static final String DEPARTMENT_ADD = "/api/v1/department/add";
    ...
    public static final String DEPARTMENT_ASSIGN_HOD = "/api/v1/department/assign/hod";
    public static final String DEPARTMENT_REMOVE_HOD = "/api/v1/department/removehod/";
